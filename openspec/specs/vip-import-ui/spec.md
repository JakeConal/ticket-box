# Capability: vip-import-ui

## Purpose
Provides the organizer-facing frontend interface for manually triggering VIP guest CSV import and reviewing per-file import results.
